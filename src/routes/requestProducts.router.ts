...
routerRequestProducts.get(
    `${path}/request-product/route/:requestRouteId`,
    (req: Request, res: Response) => {
...
routerRequestProducts.get(
    `${path}/request-products/aproved/:requestRouteId`,
    (req: Request, res: Response) => {
        controllerRequestProducts.getUniqueRequestProductAprovedByRoute(req, res);
    }
);

routerRequestProducts.post(
    `${path}/request-products/add`,
    (req: Request, res: Response) => {
        controllerRequestProducts.createRequestProducts(req, res);
    }
);
routerRequestProducts.post(
    `${path}/request-products/addproduct/:idRequest`,
    (req: Request, res: Response) => {
        controllerRequestProducts.addProductToRequest(req, res);
    }
);

routerRequestProducts.delete(
    `${path}/request-products/remove/:requestProductId`,
    (req: Request, res: Response) => {
...
routerRequestProducts.delete(
    `${path}/request-products/remove/:requestProductId/:productId`,
    (req: Request, res: Response) => {
        controllerRequestProducts.removeProductRequest(req, res);
    }
);

routerRequestProducts.patch(
    `${path}/request-products/edit/:requestProductId`,
    (req: Request, res: Response) => {
...
routerRequestProducts.patch(
    `${path}/request-products/update-acepted/:idRequest`,
    (req, res) => {
        controllerRequestProducts.updateAcepted(req, res);
    }
);
routerRequestProducts.patch(
    `${path}/request-products/update-to-acepted/:idRequest`,
    (req, res) => {
        controllerRequestProducts.updateToAcepted(req, res);
    }
);
routerRequestProducts.patch(
    `${path}/request-products/edit/:requestProductId/:productId`,
    (req: Request, res: Response) => {
...
routerRequestProducts.patch(
    `${path}/request-products/remplaceproducts/:idRequest`,
    (req: Request, res: Response) => {
...
routerRequestProducts.patch(
    `${path}/request-products/update/ammountdispatched/:idRequest`,
    (req: Request, res: Response) => {
        controllerRequestProducts.updateAmmountDispatched(req, res);
    }
);
routerRequestProducts.patch(
    `${path}/request-products/update/ammountsold/:idRequest`,
    (req: Request, res: Response) => {
        controllerRequestProducts.updateAmmountSold(req, res);
    }
);
routerRequestProducts.patch(
    `${path}/request-products/update/ammountreturn/:idRequest`,
    (req: Request, res: Response) => {
